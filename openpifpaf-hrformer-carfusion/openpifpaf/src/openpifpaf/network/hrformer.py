...
# --------------------------------------------------------
# File merging and adaptions by Michael Koepf
# Sources:
# - https://github.com/HRNet/HRFormer/blob/1245b88b5824fbd8cdb358b5ee909a4e537a2ef5/cls/models/hrt.py
# - https://github.com/HRNet/HRFormer/blob/1245b88b5824fbd8cdb358b5ee909a4e537a2ef5/cls/models/modules/basic_block.py
# - https://github.com/HRNet/HRFormer/blob/1245b88b5824fbd8cdb358b5ee909a4e537a2ef5/cls/models/modules/bottleneck_block.py
# - https://github.com/HRNet/HRFormer/blob/1245b88b5824fbd8cdb358b5ee909a4e537a2ef5/cls/models/modules/ffn_block.py
# - https://github.com/HRNet/HRFormer/blob/1245b88b5824fbd8cdb358b5ee909a4e537a2ef5/cls/models/modules/multihead_attention.py
# - https://github.com/HRNet/HRFormer/blob/1245b88b5824fbd8cdb358b5ee909a4e537a2ef5/cls/models/modules/multihead_isa_attention.py
# - https://github.com/HRNet/HRFormer/blob/1245b88b5824fbd8cdb358b5ee909a4e537a2ef5/cls/models/modules/transformer_block.py
# --------------------------------------------------------
# pylint: skip-file
...
class HighResolutionTransformer(nn.Module):
    def __init__(self, cfg, remove_final_layer):
        super(HighResolutionTransformer, self).__init__()

        self.remove_final_layer = remove_final_layer
    ...
    def forward(self, x):
        ...
        if not self.remove_final_layer:
    ...
    def init_weights(
        ...
        if isinstance(pretrained, str):
            LOG.info("Load pre-trained weights from %s", pretrained)
            self.apply(_init_weights)
            checkpoint = torch.load(pretrained, map_location='cpu')

            checkpoint_model = checkpoint['model']
            missing_keys = self.load_state_dict(checkpoint_model, strict=strict)
            LOG.debug(missing_keys)
        else:
            LOG.info("Randomly initialize weights")
            self.apply(_init_weights)
