...
class ApolloKp(DataModule):
    ...
    train_annotations = 'openpifpaf/data-apollocar3d/annotations/apollo_keypoints_66_train.json'
    val_annotations = 'openpifpaf/data-apollocar3d/annotations/apollo_keypoints_66_val.json'
    eval_annotations = val_annotations
    train_image_dir = 'openpifpaf/data-apollocar3d/images/train/'
    val_image_dir = 'openpifpaf/data-apollocar3d/images/val/'
